...
public class RecycleViewAdapterManager extends RecyclerView.Adapter<RecycleViewAdapterManager.HomeViewHolder> {

    private List<Book> list;

    private Context context;

    public RecycleViewAdapterManager(List<Book> list, Context context) {
        this.list = list;
    ...
    public RecycleViewAdapterManager() {
        list = new ArrayList<>();
    }

    @NonNull
    @Override
    public RecycleViewAdapterManager.HomeViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_sp,parent,false);
        return new HomeViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RecycleViewAdapterManager.HomeViewHolder holder, int position) {
